    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        get.enqueue(new Callback<List<TipoPrestador>>() {
            ...
            public void onResponse(Call<List<TipoPrestador>> call, Response<List<TipoPrestador>> response) {
                ...
                for(TipoPrestador tp :  listTP){
                    TipoPrestador tPres = new TipoPrestador(tp.getDescricao());
                    lista.add(tPres);
                }
                AdapterTipoPrestador adapterTipoPrestador = new AdapterTipoPrestador(getApplicationContext(), lista);
